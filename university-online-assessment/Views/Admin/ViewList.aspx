<%@ Page Title="View List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewList.aspx.cs" Inherits="university_online_assessment.Views.Admin.ViewLecturerList" %>
            ...
            <div class="tab-content table-responsive" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="nav-students" role="tabpanel" aria-labelledby="nav-students-tab">
                    ...
                    <asp:GridView runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit/Delete" HeaderStyle-ForeColor="White">
                                <ItemTemplate>
                                    <a href="/list/student/<%# Item.Id %>"><i class="far fa-edit"></i></a>
                ...
                <div class="tab-pane fade" id="nav-programmes" role="tabpanel" aria-labelledby="nav-programmes-tab">
                    ...
                    <asp:GridView runat="server"
                        ...
                        <Columns>
                            <asp:DynamicField DataField="progId" HeaderText="Programme ID" HeaderStyle-ForeColor="White" />
                            ...
                            <asp:TemplateField HeaderText="Edit/Delete" HeaderStyle-ForeColor="White">
                                <ItemTemplate>
                                    <a href="/list/programme/<%# Item.progId %>"><i class="far fa-edit"></i></a>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
